...
interface ParticleTextEffectProps {
  words?: string[]
  /** Tailwind / inline className for the wrapping div */
  className?: string
}

const DEFAULT_WORDS = ["YOUR RESUME", "PERFECTED BY AI", "RESUMEIQ"]
...
export function ParticleTextEffect({
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    // Brand green for hero words
    offscreenCtx.fillStyle = "white"
    offscreenCtx.font = "bold 96px Arial"
    ...
    // Cycle between brand green and a lighter teal
    const colorOptions = [
      { r: 16, g: 185, b: 129 },   // #10B981 brand green
      { r: 52, g: 211, b: 153 },   // lighter emerald
      { r: 110, g: 231, b: 183 },  // mint
    ]
    const newColor = colorOptions[wordIndexRef.current % colorOptions.length]
  ...
  const animate = () => {
    ...
    // Transparent dark trail — matches the #0A0A0F landing bg
